...
//! These need to be macros, as clientversion.cpp's and ukkey*-res.rc's voodoo requires it
...
/**
 * ukkeyd-res.rc includes this file, but it cannot cope with real c++ code.
